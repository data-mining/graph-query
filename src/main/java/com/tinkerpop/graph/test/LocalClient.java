...
import org.apache.tinkerpop.gremlin.structure.TitanVertex;
...
public class LocalClient {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            TitanVertex ug1 = tx.addVertex(T.label, "UserGroup", "userGroupName", "Technical", "uuid",
                    "297ac8df-cb23-4fdb-89c2-c551f90fb9f0");

            TitanVertex ug2 = tx.addVertex(T.label, "UserGroup", "userGroupName", "Management", "uuid",
                    "94257118-f632-44a3-aec8-e841f61bf784");

            TitanVertex ug3 = tx.addVertex(T.label, "UserGroup", "userGroupName", "Human Resource", "uuid",
                    "d02ec68f-eab2-4e1d-a7f8-58539fbcae09");

            /////////

            TitanVertex u1 = tx.addVertex(T.label, "User", "userName", "dachulin", "uuid",
                    "79352101-d49d-458f-8c18-d6af4863eb97");

            TitanVertex u2 = tx.addVertex(T.label, "User", "userName", "utjaiswa", "uuid",
                    "b55f4d53-b9d6-4155-8602-ee1946d52385");

            TitanVertex u3 = tx.addVertex(T.label, "User", "userName", "rvilkhu", "uuid",
                    "dcdbccd0-7da4-470b-b2a1-645a4e30fc23");

            TitanVertex u4 = tx.addVertex(T.label, "User", "userName", "manchakr", "uuid",
                    "7597103d-9a3d-4b00-9576-67fca4c45683");

            TitanVertex u5 = tx.addVertex(T.label, "User", "userName", "vveguru", "uuid",
                    "0a97e905-92bd-424d-83ef-e4b58d0ca087");

            TitanVertex u6 = tx.addVertex(T.label, "User", "userName", "shgattu", "uuid",
                    "c63cc431-1a98-4f43-a9c7-30f4a1c3d555");

            TitanVertex u7 = tx.addVertex(T.label, "User", "userName", "liangbin", "uuid",
                    "fbe113ce-97c9-4a71-8445-d056a7ebbadd");

            TitanVertex u8 = tx.addVertex(T.label, "User", "userName", "kmandal", "uuid",
                    "fe4f9ce7-3860-4e26-b658-3e9503008fe5");

            TitanVertex u9 = tx.addVertex(T.label, "User", "userName", "rnethi", "uuid",
                    "3016298b-fbc5-404c-acf7-a0f933fa7c02");

            TitanVertex u10 = tx.addVertex(T.label, "User", "userName", "apbanerj", "uuid",
            ...
            TitanVertex ed1 = tx.addVertex(T.label, "EndDevice", "endDevName", "rnethi-M-88XY", "uuid",
                    "f17807f8-c36d-4f04-bb00-9053f014d3ac");

            TitanVertex ed2 = tx.addVertex(T.label, "EndDevice", "endDevName", "LIANGBIN-M-88XY", "uuid",
                    "87bb8a74-baf3-46e7-8722-1bc0a5ff93c3");

            TitanVertex ed3 = tx.addVertex(T.label, "EndDevice", "endDevName", "SRV_62.7.4.6", "uuid",
                    "c75d9d43-4860-42d2-b20a-e60c42d75963");

            TitanVertex ed4 = tx.addVertex(T.label, "EndDevice", "endDevName", "SRV_62.7.4.3", "uuid",
                    "12fac2a5-13ae-4923-bb4d-ef27f3b84ebe");

            TitanVertex ed5 = tx.addVertex(T.label, "EndDevice", "endDevName", "dachulin-M-88XY", "uuid",
                    "17ae4373-b9a1-4bac-92f8-8f4039545e22");

            TitanVertex ed6 = tx.addVertex(T.label, "EndDevice", "endDevName", "rvilkhu-M-88XY", "uuid",
                    "b0f9790a-ff63-4c1b-8eb9-be0817daed3d");

            TitanVertex ed7 = tx.addVertex(T.label, "EndDevice", "endDevName", "apbanerj-M-88XY", "uuid",
                    "6f0cf412-199b-493e-8bc2-a12ed7cf2e53");

            TitanVertex ed8 = tx.addVertex(T.label, "EndDevice", "endDevName", "kmandal-M-88XY", "uuid",
                    "aadd7f65-1177-40f0-abd3-93bccf47011b");

            TitanVertex ed9 = tx.addVertex(T.label, "EndDevice", "endDevName", "SRV_rocket", "uuid",
                    "97242358-cf16-4a06-afde-a8dd5e0f813e");

            TitanVertex ed10 = tx.addVertex(T.label, "EndDevice", "endDevName", "SRV_62.7.4.4", "uuid",
            ...
            TitanVertex ep1 = tx.addVertex(T.label, "EndPoint", "ipAddr", "10.10.1.13", "uuid",
                    "a300604d-5d82-4d32-911b-5436dc9d204d");

            TitanVertex ep2 = tx.addVertex(T.label, "EndPoint", "ipAddr", "10.10.1.15", "uuid",
                    "ddc42928-faeb-42b5-96a9-0a68c7fbd075");

            TitanVertex ep3 = tx.addVertex(T.label, "EndPoint", "ipAddr", "10.10.3.18", "uuid",
                    "5c2881bc-9f96-4d4d-981c-680e56a1e908");

            TitanVertex ep4 = tx.addVertex(T.label, "EndPoint", "ipAddr", "10.10.1.14", "uuid",
            ...
            TitanVertex app1 = tx.addVertex(T.label, "ServiceInstance", "serviceName", "WWW", "uuid",
                    "f62fce74-4366-4fb9-a0ac-b3a8f4d4300a");

            TitanVertex app2 = tx.addVertex(T.label, "ServiceInstance", "serviceName", "Cisco Jabber", "uuid",
                    "ddc42928-faeb-42b5-96a9-0a68c7fbd075");

            TitanVertex app3 = tx.addVertex(T.label, "ServiceInstance", "serviceName", "Webex", "uuid",
                    "3e3e924a-530d-4bda-8cf9-976bcff95c14");

            TitanVertex app4 = tx.addVertex(T.label, "ServiceInstance", "serviceName", "Youtube", "uuid",
